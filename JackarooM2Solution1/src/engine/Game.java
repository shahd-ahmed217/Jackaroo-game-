...
public class Game implements GameManager {
    ...
    public void deselectMarble(Marble marble) throws InvalidMarbleException {
        players.get(currentPlayerIndex).deselectMarble(marble);
    }
    ...
    public void playPlayerTurn() throws GameException {
    	...
    	catch(IllegalDestroyException f) {

             throw f;
    	}
    	catch(IllegalSwapException g) {

             throw g;
    	}
    	catch(CannotDiscardException h) {

            throw h;
    	}
    	catch(IllegalMovementException i) {
    ...
    public void passTurn (){
    	...
    	discardCard(players.get(currentPlayerIndex).getColour());
    }
    	catch(Exception e){
    		
    	}}
    public void discardSpecificCard(Card c) {
    	if (players.get(currentPlayerIndex).getHand().contains(c))
